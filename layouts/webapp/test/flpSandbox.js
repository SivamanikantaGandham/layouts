		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comdemolayoutslayouts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemolayoutslayouts-display": {
								"semanticObject": "comdemolayoutslayouts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.layouts.layouts",
									"url": sap.ui.require.toUrl("com/demo/layouts/layouts")
								}
							}
						}
					}
